...
| guitar | 33 | F | `F°7` | `xx1212` |
| guitar | 36 | Ab | `Ab°7` | `4x2323` |
| mandolin | [3, 4] | Bb | `Bbm7b5` | `4355` |
| mandolin | [19, 20] | Gb | `Gb°` | `4324` |
...
The only voicing given, so a canonical fingering was generated from theory. These print with a dagger (\dag) in the book and are the ones worth checking against the paper notebook first.

| Instrument | Page | Key | Chord | As read | Printed |
|---|---|---|---|---|---|
| guitar | 32 | E | `E°7` | `x23132` | `012020` |
| guitar | 33 | F | `F°7` | `xx1212` | `1x0101` |
